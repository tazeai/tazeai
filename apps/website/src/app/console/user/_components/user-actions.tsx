...
import { MoreHorizontal, ShieldAlert, ShieldCheck, Trash, UserCog } from 'lucide-react';
...
export function UserActions({ user, onEdit, onDelete, onToggleStatus }: UserActionsProps) {
  return (
    <DropdownMenu>
