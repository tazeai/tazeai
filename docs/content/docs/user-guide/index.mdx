---
title: User Guide
description: How to use TazeAI effectively
---

# TazeAI User Guide

This guide will help you get the most out of TazeAI as a designer working with React and TailwindCSS projects.

## Basic Concepts

TazeAI provides a visual interface for editing React components while automatically generating the corresponding code. Key concepts include:
