---
title: Features
description: Overview of TazeAI's features
---

# TazeAI Features

TazeAI provides a range of features to help designers and developers work together more efficiently.

![Features Overview](/images/features-overview.png)
*TazeAI offers powerful features to streamline your design-to-code workflow*
...
<Cards>
  ...
  <Card title="Figma to TazeAI" href="/docs/features/figma-to-tazeai" />
...
*TazeAI's Visual Editor provides a familiar design tool interface*

## Code Integration

TazeAI integrates seamlessly with your code, allowing you to:
...
TazeAI's AI assistance helps you:
...
Import your Figma designs directly into TazeAI to:
...
![Figma to TazeAI](/images/figma-to-tazeai.png)
