---
title: Contributing
description: How to contribute to the TazeAI project
---

# Contributing to TazeAI

We welcome contributions to TazeAI! This guide will help you get started with contributing to the project.

When contributing to this repository, please first discuss the change you wish to make via [issues](https://github.com/tazeai/tazeai/issues),
[Discord](https://discord.gg), [email](mailto:help@tazeai.com), or any other method with the owners of this repository before making a change. 

Please note we have a [code of conduct](https://github.com/tazeai/tazeai/blob/main/CODE_OF_CONDUCT.md), please follow it in all your interactions with the project.
