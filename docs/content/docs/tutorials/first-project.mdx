...
description: Learn how to create your first project in TazeAI
---

# Creating Your First Project

This tutorial will guide you through creating your first project in TazeAI.

## Prerequisites

Before you begin, make sure you have:

- Installed TazeAI (see [Installation](/docs/getting-started/installation))
...
Take some time to explore the TazeAI interface:
