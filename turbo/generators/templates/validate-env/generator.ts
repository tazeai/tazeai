...
import { z } from '../../../../apps/website/node_modules/zod';
...
const Schema: Record<string, z.ZodType> = {
  NEXT_PUBLIC_SITE_URL: z
    .string({
      description: `This is the URL of your website. It should start with https:// like https://tazeai.com.`,
    })
    .url({
      message:
  ...
  NEXT_PUBLIC_PRODUCT_NAME: z
    .string({
      ...
      description: `This is the name of your product. It should be a short name like TazeAI.`,
    })
    .min(1),
