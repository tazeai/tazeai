  ...
  return plop.setGenerator('env', {
    ...
    prompts: [
      ...
      },
      {
        ...
        message: `What is the email sender? (ex. info@tazeai.com).\nFor more info: ${getUrlToDocs('EMAIL_SENDER')}\n`,
      },
      {
